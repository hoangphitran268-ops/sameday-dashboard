...
import ReceivingSellerTable from "@/components/ReceivingSellerTable";
import type { ReceivingSellerRow } from "@/lib/types";
import { dict, type Lang } from "@/lib/i18n";

export default function ReceivingSellerTabs({
  worst,
  best,
  lang = "vi",
}: {
  worst: ReceivingSellerRow[];
  best: ReceivingSellerRow[];
  lang?: Lang;
}) {
  ...
  return (
    <div>
      ...
      <ReceivingSellerTable rows={tab === "worst" ? worst : best} lang={lang} />
    </div>
  );
}
